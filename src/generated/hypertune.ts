...
export const queryCode = `query FullQuery{root{beta}}`;

export const query: sdk.Query<sdk.ObjectValueWithVariables> = {"variableDefinitions":{},"fragmentDefinitions":{},"fieldQuery":{"Query":{"type":"InlineFragment","objectTypeName":"Query","selection":{"root":{"fieldArguments":{"__isPartialObject__":true},"fieldQuery":{"Root":{"type":"InlineFragment","objectTypeName":"Root","selection":{"beta":{"fieldArguments":{},"fieldQuery":null}}}}}}}}};

export const vercelFlagDefinitions = {"beta":{"options":[{"label":"Off","value":false},{"label":"On","value":true}],"origin":"https://app.hypertune.com/projects/8208/main/draft/logic?selected_field_path=root%3Ebeta"}};
...
export class RootNode extends sdk.Node {
  ...
  /**
   * [Open in Hypertune UI]({@link https://app.hypertune.com/projects/8208/main/draft/logic?selected_field_path=root%3Ebeta})
   */
  beta({ args = {}, fallback }: { args?: EmptyObject; fallback: boolean; }): boolean {
    const props0 = this.getFieldNodeProps("beta", { fieldArguments: args });
...
const sourceFallback = {root:{beta:false}};
