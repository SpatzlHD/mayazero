              ...
              <div className="flex flex-col gap-1.5 max-h-[160px] overflow-y-auto custom-scrollbar">
                {state.sessions.map((session) => (
                  <button
                    key={session.id}
                    onClick={() =>
                      runWalletAction(() => wallet.selectSession(session.id))
                    }
                  ...
                  >
                    <div className="flex flex-col">
                      ...
                      <span className="text-[10px] font-normal text-[var(--sea-ink-soft)]">
                        {session.kind}
                      </span>
                    </div>
          ...
          {activeSession ? (
            ...
            <div className="mt-4 p-4 text-center rounded-xl bg-[var(--surface)] border border-[var(--line)]">
              ...
              <button
                ...
                className="w-full p-2.5 rounded-lg text-xs font-bold bg-[var(--maya-teal)] text-[var(--bg-base)] shadow-[0_0_10px_rgba(26,154,141,0.2)] hover:scale-[1.02] transition-all flex items-center justify-center gap-1.5"
              >
